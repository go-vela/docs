...
## Internal Secrets
Internal secrets are generally managed via the UI or the [CLI](/docs/reference/cli/secret/secret.md). They can also be managed via the [API](/docs/reference/api/secret/).
...
You may also use the [CLI](/docs/reference/cli/secret) or [API](/docs/reference/api/secret/secret.md)
:::
